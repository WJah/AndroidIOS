...
public class bypassMain extends NSObject implements UIApplicationDelegate {

    public static void main(String[] args) {
        UIKit.UIApplicationMain(0, null, null, bypassMain.class.getName());
    }
	...
	@Owned
	@Selector("alloc")
	public static native bypassMain alloc();

	@Generated("NatJ")
	protected bypassMain(Pointer peer) {
		super(peer);
	}
	...
	public void onClick(final UIButton sender) {
		System.out.printf("captured %n");
    }
	
	private void runDemo() {
		Activity0 a0 = Activity0.alloc();
		Activity1 a1 = Activity1.alloc();
	...
	public native boolean applicationOpenURLSourceApplicationAnnotation(
			...
			@Mapped(com.intel.inde.moe.natj.objc.map.ObjCObjectMapper.class) Object annotation);
