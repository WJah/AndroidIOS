...
public class Activity0 extends ActivityViewController{
	static {
		NatJ.register();
	}
	...
	@Owned
	@Selector("alloc")
	public static native Activity0 alloc();

	@Generated("NatJ")
	protected Activity0(Pointer peer) {
		super(peer);
		
	   UIButton button;
	   button = UIButton.alloc().initWithFrame(new CGRect(new CGPoint(0, 200), new CGSize(200, 50)));
	...
	public void onClick(final UIButton sender) {
		System.out.printf("captured 0%n");
		next.setVisible();
    }
}
